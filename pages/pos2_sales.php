	...
	<form method="POST">
		<div class="container">
			<h2 align="center"><label id="home">Point of Sale (B) Sales Report</label>
								...
								//output  data of each row
									while ($row = $result-> fetch_assoc()) {
										echo "<tr class = 'tr-data'>
												<td style = 'width:97px;color:cyan;text-decoration:underline;'>" . $row["pos2_id"] . "</td>
												<td style = 'width:192px'>" .$row["item_name"]. "</td>
												...
												<td style = 'width:95px'>" . $row["total_quantity"] . " Pc(s)</td>
												<td style = 'width:95px'>&#8369; " . $row["total_discount_given"] . "</td>
												<td style = 'width:95px'>&#8369; " . $row["total_discounted_amount"] . "</td>
	...
	<script>
		...
		$(document).ready(function(){
			$('#home').click(function(){
				window.location.replace("index.php?page=pos2_sales&user_id=<?php echo $user_id; ?>");
			});
		});
	</script>
