	...
	<form method="POST">
		<div class="container">
			<h2 align="center"><label id="home">Syra Tech Payroll Employee List</label>
								...
								//output  data of each row
									while ($row = $result-> fetch_assoc()) {
										...
										echo "<tr row_id='" . $emp_no . "' user_id='".$user_id."' class = 'tr-data'>
												...
												<td style = 'width:95px'>" . $row["qualified_dependent_status"] . "</td>
											</tr>";
									}
									echo "</table>";	
								}
	...
	<script>
		...
		$(document).ready(function(){
			$('.table_emp table tbody tr').click(function(){
				...
				window.location.replace("index.php?page=payrollform&emp_id=" +id+"&user_id="+user_id);
			});
			$('#home').click(function(){
				window.location.replace("index.php?page=payroll&user_id=<?php echo $user_id; ?>");
			});
		});
	</script>
